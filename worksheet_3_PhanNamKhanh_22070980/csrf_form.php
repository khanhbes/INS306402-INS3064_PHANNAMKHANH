...
<head>
    ...
    <style>
        ...
        .secure-zone { padding: 20px; border: 2px dashed #28a745; max-width: 400px; }
        .alert { background: #d4edda; color: #155724; padding: 10px; margin-bottom: 15px; border: 1px solid #c3e6cb; }
        button.danger { background: #dc3545; color: white; border: none; padding: 10px; cursor: pointer; }
    </style>
</head>
<body>
