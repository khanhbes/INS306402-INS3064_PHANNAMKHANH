...
// Lấy tham số 'page' từ URL, mặc định là 'home' nếu không có [cite: 169-170]
$page = $_GET['page'] ?? 'home';
...
<body <nav>
    ...
    <div class="content">
        <?php
        // Logic Routing (Điều hướng) [cite: 169-171]
        if (in_array($page, $allowedPages)) {
            // Nếu hợp lệ, nhúng file tương ứng từ thư mục pages/
            include __DIR__ . "/pages/{$page}.php";
        } else {
            // Nếu không hợp lệ, trả về mã lỗi HTTP 404 và hiển thị trang 404 [cite: 170]
