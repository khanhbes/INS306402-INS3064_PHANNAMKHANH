...
<head>
    ...
    <style>
        ...
        .form-container { max-width: 400px; padding: 20px; border: 1px solid #ccc; background: #fafafa; }
        .form-group { margin-bottom: 20px; }
        input[type="text"], input[type="password"] { width: 100%; padding: 8px; box-sizing: border-box; }
        .error-text { color: #dc3545; font-size: 0.9em; margin-top: 5px; display: block; }
        .success { color: #155724; background: #d4edda; padding: 10px; margin-bottom: 15px; border: 1px solid #c3e6cb; }
